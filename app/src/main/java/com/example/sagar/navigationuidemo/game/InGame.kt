...
class InGame : VerboseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        checkBox.setOnClickListener(gameOverListener)
        checkBox2.setOnClickListener(gameOverListener)
        checkBox4.setOnClickListener(gameOverListener)
